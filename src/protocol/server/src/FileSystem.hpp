...
private:
   ...
   * @return The position of the EOF in within the last block of a file. -1
   * Otherwise.
   */
...
public:
  ...
  void print();
  /**
   * @brief Gives a file outside of the FileSystem the contents of a File thats
   * in it.
   *
   */
  ...
  static void signalHandler(int signal) {
    std::cout << "FileSystem received signal " << signal
